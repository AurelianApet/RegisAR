...
public class OnlineMapsRasterTile : OnlineMapsTile
{
    ...
    /// </summary>
    public new static Texture2D emptyColorTexture;

    /// <summary>
    /// Labels is used in tile?
    /// </summary>
    public new bool labels;
    ...
    public new OnlineMapsProvider.MapType mapType;
    ...
    /// </summary>
    public new OnlineMapsWWW trafficWWW;
    ...
    public new void ApplyTexture(Texture2D texture)
    {
        _colors = texture.GetPixels32();
    ...
    public new void CheckTextureSize(Texture2D texture)
    {
