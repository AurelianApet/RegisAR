...
public static class OnlineMapsUtils
{
    ...
    /// </summary>
    /// <param name="obj">The object to destroy.</param>
    [Obsolete("Use OnlineMapsUtils.Destroy")]
    ...
    /// <summary>
    /// Given a start point, angle and distance, this will calculate the destina璽ion point travelling along a (shortest distance) great circle arc.
    /// </summary>
