...
public class OnlineMapsMarker3D : OnlineMapsMarkerBase
{
    ...
    public override bool enabled
    {
        set
        {
            if (_enabled != value)
            {
                ...
                else if (Application.isPlaying) Update();
    ...
    [Obsolete]
    public void Update(Vector2 topLeftPosition, Vector2 bottomRightPosition, int zoom)
    {
        Update(topLeftPosition.x, topLeftPosition.y, bottomRightPosition.x, bottomRightPosition.y, zoom);
    }
}
