...
if (Prism.languages.csharp) {
	...
	var Tags = {
		Unity: {
			'AnimationCurve': 1, 'Application': 1, 'Bounds': 1, 'Camera': 1, 'Canvas': 1, 'Collider': 1, 'Color': 1, 'Color32': 1, 'Debug': 1, 'GameObject': 1, 'GUI': 1, 'GUIContent': 1, 'GUIStyle': 1, 'GUITexture': 1, 'Input': 1, 'KeyCode': 1, 'Material': 1, 'Mathf': 1, 'Mesh': 1, 'MeshFilter': 1, 'MeshRenderer': 1, 'MonoBehaviour': 1, 'Random': 1, 'PlayerPrefs': 1, 'Quaternion': 1, 'Rect': 1, 'RectTransform': 1, 'RectTransformUtility': 1, 'Resources': 1, 'Screen': 1, 'Shader': 1, 'Texture': 1, 'Texture2D': 1, 'TextureFormat': 1, 'TextureWrapMode': 1, 'Time': 1, 'Transform': 1, 'Vector2': 1, 'Vector3': 1
		},
		OnlineMaps: {
			'OnlineMaps': 1, 'OnlineMapsBingMapsLocation': 1, 'OnlineMapsBingMapsLocationResult': 1, 'OnlineMapsControlBase': 1, 'OnlineMapsControlBase3D': 1, 'OnlineMapsDirectionStep': 1, 'OnlineMapsDrawingElement': 1, 'OnlineMapsDrawingLine': 1, 'OnlineMapsDrawingPoly': 1, 'OnlineMapsDrawingRect': 1, 'OnlineMapsFindAutocomplete': 1, 'OnlineMapsFindAutocompleteResult': 1, 'OnlineMapsFindDirection': 1, 'OnlineMapsFindLocation': 1, 'OnlineMapsFindPlaces': 1, 'OnlineMapsFindPlacesResult': 1, 'OnlineMapsGetElevation': 1, 'OnlineMapsGetElevationResult': 1, 'OnlineMapsGoogleAPIQuery': 1, 'OnlineMapsGUITextureControl': 1, 'OnlineMapsHereRoutingAPI': 1, 'OnlineMapsHereRoutingAPIResult': 1, 'OnlineMapsLocationService': 1, 'OnlineMapsMarker': 1, 'OnlineMapsMarker3D': 1, 'OnlineMapsMarkerBase': 1, 'OnlineMapsOSMAPIQuery': 1, 'OnlineMapsOSMNode': 1, 'OnlineMapsOSMRelation': 1, 'OnlineMapsOSMWay': 1, 'OnlineMapsPositionRange': 1, 'OnlineMapsRange': 1, 'OnlineMapsTile': 1, 'OnlineMapsTileSetControl': 1, 'OnlineMapsUtils': 1, 'OnlineMapsXML': 1
		}
	}
}
